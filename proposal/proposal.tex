...
\textbf{Michigan Genomics Initiative (validation):} The MGI is a precision health research program based at the University of Michigan in Ann Arbor consisting of an opt-in study for hospital patients at the Michigan Medicine Hospital \cite{Zawistowski2023}. This dataset consists of medical records for over 100,000 patients \cite{Zawistowski2023}. As of Freeze 5, 70,439 individuals have been genotyped and imputed to the Trans-Omics for Precision Medicine (TopMed) rare variant reference panel consisting of \>50 million variants \cite{Zawistowski2023}.
