...
\noindent
\textbf{Relevant Faculty: } Mike Boehnke, Ryan Millis, Stephen CJ Parker, Maureen Sartor
...
\textbf{Aim 2a: Within a gene, identify loci of individual variants affecting MetS.} We can perform Leave One Variant Out (LOVO) studies on the effects of variants within an implicated gene to understand if the effects of the protein-altering variants are restricted to a specific region of the gene or not.
